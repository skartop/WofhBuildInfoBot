module.exports = {
    ...
    "General help" : {
        ...
        + "> `!си землянка 11`\n"
        + "> `!си землянка 11 13`\n"
        + "> `!си перестроить землянка 11`\n"
        + "Команды можно начинать с `!си` или упомяни меня в сообщении `@BuildInfoBot`\n"
    ...
    "no building selected" : {
        en: "Can't understand what building selected (`!bi help` for help)",
        ru: "Не могу понять о каком строение речь ('!си помощь' для справки)"
    },
